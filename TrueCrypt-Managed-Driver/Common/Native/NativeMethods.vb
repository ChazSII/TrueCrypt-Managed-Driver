...
#Region "DeviceIoControl"
        ...
        Public Function DeviceIoControl(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As IntPtr, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As IntPtr, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function

        <DllImport("kernel32.dll", EntryPoint:="DeviceIoControl", SetLastError:=True, CharSet:=CharSet.Unicode)>
        Public Function DeviceIoControlMount(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As Driver.MOUNT_STRUCT, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As Driver.MOUNT_STRUCT, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function

        <DllImport("kernel32.dll", EntryPoint:="DeviceIoControl", SetLastError:=True, CharSet:=CharSet.Unicode)>
        Public Function DeviceIoControlUnmount(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As Driver.UNMOUNT_STRUCT, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As Driver.UNMOUNT_STRUCT, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function

        <DllImport("kernel32.dll", EntryPoint:="DeviceIoControl", SetLastError:=True, CharSet:=CharSet.Unicode)>
        Public Function DeviceIoControlListMounted(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As Driver.MOUNT_LIST_STRUCT, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As Driver.MOUNT_LIST_STRUCT, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function

        <DllImport("kernel32.dll", EntryPoint:="DeviceIoControl", SetLastError:=True, CharSet:=CharSet.Unicode)>
        Public Function DeviceIoControlOpenTest(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As Driver.OPEN_TEST_STRUCT, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As Driver.OPEN_TEST_STRUCT, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function

        <DllImport("kernel32.dll", EntryPoint:="DeviceIoControl", SetLastError:=True, CharSet:=CharSet.Unicode)>
        Public Function DeviceIoControlVolProp(ByVal hDevice As IntPtr, ByVal dwIoControlCode As Driver.IoCtrlCodes, ByVal lpInBuffer As Driver.VOLUME_PROPERTIES_STRUCT, ByVal nInBufferSize As UInteger, ByRef lpOutBuffer As Driver.VOLUME_PROPERTIES_STRUCT, ByVal nOutBufferSize As UInteger, ByRef lpBytesReturned As UInteger, ByVal lpOverlapped As IntPtr) As Boolean
        End Function
#End Region
